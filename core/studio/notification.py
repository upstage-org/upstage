...
from core.studio.media import AssetUsage
from core.user.user_utils import current_user
from core.licenses.models import AssetUsage as AssetUsageModel
...
class Notification(graphene.ObjectType):
    ...
    mediaUsage = graphene.Field(
        AssetUsage,
        description="If notification is of type media usage, this object contain the permission request",
    )
