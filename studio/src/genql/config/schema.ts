...
export interface MutationGenqlSelection{
    /** Mutation to update Terms of Service's URL. */
    updateTermsOfService?: (UpdateTermsOfServiceGenqlSelection & { __args: {url: Scalars['String']} })
    /** Mutation to customise foyer. */
    saveConfig?: (SaveConfigGenqlSelection & { __args: {
...
export interface SendEmailGenqlSelection{
    ...
    export const isNginxConfig = (obj?: { __typename?: any } | null): obj is NginxConfig => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isNginxConfig"')
    ...
    export const isSystemConfig = (obj?: { __typename?: any } | null): obj is SystemConfig => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSystemConfig"')
    ...
    export const isFoyerConfig = (obj?: { __typename?: any } | null): obj is FoyerConfig => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isFoyerConfig"')
    ...
    export const isUpdateTermsOfService = (obj?: { __typename?: any } | null): obj is UpdateTermsOfService => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpdateTermsOfService"')
    ...
    export const isSaveConfig = (obj?: { __typename?: any } | null): obj is SaveConfig => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSaveConfig"')
