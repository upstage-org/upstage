...
export type Node = (AssetType | Tag | User | Asset | AssetUsage | Stage | AdminPlayer | Notification | Voice) & { __isUnion?: true }
...
export type AssetTypeSortEnum = 'ID_ASC' | 'ID_DESC' | 'NAME_ASC' | 'NAME_DESC' | 'DESCRIPTION_ASC' | 'DESCRIPTION_DESC' | 'FILE_LOCATION_ASC' | 'FILE_LOCATION_DESC' | 'CREATED_ON_ASC' | 'CREATED_ON_DESC'
...
export type TagSortEnum = 'ID_ASC' | 'ID_DESC' | 'NAME_ASC' | 'NAME_DESC' | 'COLOR_ASC' | 'COLOR_DESC' | 'CREATED_ON_ASC' | 'CREATED_ON_DESC'
...
export type UserSortEnum = 'ID_ASC' | 'ID_DESC' | 'USERNAME_ASC' | 'USERNAME_DESC' | 'PASSWORD_ASC' | 'PASSWORD_DESC' | 'EMAIL_ASC' | 'EMAIL_DESC' | 'BIN_NAME_ASC' | 'BIN_NAME_DESC' | 'ROLE_ASC' | 'ROLE_DESC' | 'FIRST_NAME_ASC' | 'FIRST_NAME_DESC' | 'LAST_NAME_ASC' | 'LAST_NAME_DESC' | 'DISPLAY_NAME_ASC' | 'DISPLAY_NAME_DESC' | 'ACTIVE_ASC' | 'ACTIVE_DESC' | 'CREATED_ON_ASC' | 'CREATED_ON_DESC' | 'FIREBASE_PUSHNOT_ID_ASC' | 'FIREBASE_PUSHNOT_ID_DESC' | 'DEACTIVATED_ON_ASC' | 'DEACTIVATED_ON_DESC' | 'UPLOAD_LIMIT_ASC' | 'UPLOAD_LIMIT_DESC' | 'INTRO_ASC' | 'INTRO_DESC' | 'CAN_SEND_EMAIL_ASC' | 'CAN_SEND_EMAIL_DESC' | 'LAST_LOGIN_ASC' | 'LAST_LOGIN_DESC'
...
export type Previlege = 'NONE' | 'OWNER' | 'APPROVED' | 'PENDING_APPROVAL' | 'REQUIRE_APPROVAL'

export type AssetSortEnum = 'ID_ASC' | 'ID_DESC' | 'NAME_ASC' | 'NAME_DESC' | 'ASSET_TYPE_ID_ASC' | 'ASSET_TYPE_ID_DESC' | 'OWNER_ID_ASC' | 'OWNER_ID_DESC' | 'DESCRIPTION_ASC' | 'DESCRIPTION_DESC' | 'FILE_LOCATION_ASC' | 'FILE_LOCATION_DESC' | 'CREATED_ON_ASC' | 'CREATED_ON_DESC' | 'UPDATED_ON_ASC' | 'UPDATED_ON_DESC' | 'SIZE_ASC' | 'SIZE_DESC' | 'COPYRIGHT_LEVEL_ASC' | 'COPYRIGHT_LEVEL_DESC'
...
export type StageSortEnum = 'ID_ASC' | 'ID_DESC' | 'NAME_ASC' | 'NAME_DESC' | 'DESCRIPTION_ASC' | 'DESCRIPTION_DESC' | 'OWNER_ID_ASC' | 'OWNER_ID_DESC' | 'FILE_LOCATION_ASC' | 'FILE_LOCATION_DESC' | 'CREATED_ON_ASC' | 'CREATED_ON_DESC' | 'LAST_ACCESS_ASC' | 'LAST_ACCESS_DESC'
...
export type AdminPlayerSortEnum = 'ID_ASC' | 'ID_DESC' | 'USERNAME_ASC' | 'USERNAME_DESC' | 'PASSWORD_ASC' | 'PASSWORD_DESC' | 'EMAIL_ASC' | 'EMAIL_DESC' | 'BIN_NAME_ASC' | 'BIN_NAME_DESC' | 'ROLE_ASC' | 'ROLE_DESC' | 'FIRST_NAME_ASC' | 'FIRST_NAME_DESC' | 'LAST_NAME_ASC' | 'LAST_NAME_DESC' | 'DISPLAY_NAME_ASC' | 'DISPLAY_NAME_DESC' | 'ACTIVE_ASC' | 'ACTIVE_DESC' | 'CREATED_ON_ASC' | 'CREATED_ON_DESC' | 'FIREBASE_PUSHNOT_ID_ASC' | 'FIREBASE_PUSHNOT_ID_DESC' | 'DEACTIVATED_ON_ASC' | 'DEACTIVATED_ON_DESC' | 'UPLOAD_LIMIT_ASC' | 'UPLOAD_LIMIT_DESC' | 'INTRO_ASC' | 'INTRO_DESC' | 'CAN_SEND_EMAIL_ASC' | 'CAN_SEND_EMAIL_DESC' | 'LAST_LOGIN_ASC' | 'LAST_LOGIN_DESC'
...
export interface QueryGenqlSelection{
    ...
    /** The ID of the object */
    id: Scalars['ID']} })
    mediaTypes?: (AssetTypeConnectionGenqlSelection & { __args?: {sort?: ((AssetTypeSortEnum | null)[] | null), before?: (Scalars['String'] | null), after?: (Scalars['String'] | null), first?: (Scalars['Int'] | null), last?: (Scalars['Int'] | null)} })
    tags?: (TagConnectionGenqlSelection & { __args?: {sort?: ((TagSortEnum | null)[] | null), before?: (Scalars['String'] | null), after?: (Scalars['String'] | null), first?: (Scalars['Int'] | null), last?: (Scalars['Int'] | null)} })
    users?: (UserConnectionGenqlSelection & { __args?: {active?: (Scalars['Boolean'] | null), sort?: ((UserSortEnum | null)[] | null), before?: (Scalars['String'] | null), after?: (Scalars['String'] | null), first?: (Scalars['Int'] | null), last?: (Scalars['Int'] | null)} })
    media?: (AssetConnectionGenqlSelection & { __args?: {id?: (Scalars['ID'] | null), nameLike?: (Scalars['String'] | null), createdBetween?: ((Scalars['Date'] | null)[] | null), fileLocation?: (Scalars['String'] | null), mediaTypes?: ((Scalars['String'] | null)[] | null), owners?: ((Scalars['String'] | null)[] | null), stages?: ((Scalars['Int'] | null)[] | null), tags?: ((Scalars['String'] | null)[] | null), sort?: ((AssetSortEnum | null)[] | null), before?: (Scalars['String'] | null), after?: (Scalars['String'] | null), first?: (Scalars['Int'] | null), last?: (Scalars['Int'] | null)} })
    stages?: (StageConnectionGenqlSelection & { __args?: {id?: (Scalars['ID'] | null), nameLike?: (Scalars['String'] | null), createdBetween?: ((Scalars['Date'] | null)[] | null), fileLocation?: (Scalars['String'] | null), owners?: ((Scalars['String'] | null)[] | null), sort?: ((StageSortEnum | null)[] | null), before?: (Scalars['String'] | null), after?: (Scalars['String'] | null), first?: (Scalars['Int'] | null), last?: (Scalars['Int'] | null)} })
    adminPlayers?: (AdminPlayerConnectionGenqlSelection & { __args?: {id?: (Scalars['ID'] | null), usernameLike?: (Scalars['String'] | null), createdBetween?: ((Scalars['Date'] | null)[] | null), role?: (Scalars['Int'] | null), sort?: ((AdminPlayerSortEnum | null)[] | null), before?: (Scalars['String'] | null), after?: (Scalars['String'] | null), first?: (Scalars['Int'] | null), last?: (Scalars['Int'] | null)} })
    /** Logged in user info */
...
export interface MutationGenqlSelection{
    ...
    /** Mutation to delete a media. */
    deleteMedia?: (DeleteMediaGenqlSelection & { __args: {
    /** Global Id of the asset to be deleted. */
    id: Scalars['ID']} })
    /** Mutation to upload a media. */
    uploadFile?: (UploadFileGenqlSelection & { __args: {
    ...
    authUser?: (AuthMutationGenqlSelection & { __args?: {password?: (Scalars['String'] | null), username?: (Scalars['String'] | null)} })
    refreshUser?: (RefreshMutationGenqlSelection & { __args?: {refreshToken?: (Scalars['String'] | null)} })
    /** Mutation to approve or reject a media usage request */
    confirmPermission?: (ConfirmPermissionGenqlSelection & { __args?: {
    ...
    id?: (Scalars['ID'] | null)} })
    /** Mutation to create an asset usage */
    requestPermission?: (RequestPermissionGenqlSelection & { __args?: {
    /** ID of the media usage request */
    assetId?: (Scalars['ID'] | null), 
    /** Note for the media usage request */
    note?: (Scalars['String'] | null)} })
    /** Mutation to assign a stage to a media */
    quickAssignMutation?: (QuickAssignMutationGenqlSelection & { __args?: {
    /** ID of the media */
    id?: (Scalars['ID'] | null), 
    /** ID of the stage */
    stageId?: (Scalars['Int'] | null)} })
    /** Mutation to update a stage status attribute. */
    updateStatus?: (UpdateAttributeStatusGenqlSelection & { __args: {
    /** Global Id of the stage. */
    stageId: Scalars['ID']} })
    /** Mutation to update a stage visibility attribute. */
    updateVisibility?: (UpdateAttributeVisibilityGenqlSelection & { __args: {
    /** Global Id of the stage. */
    stageId: Scalars['ID']} })
    /** Update a user. */
    updateUser?: (UpdateUserGenqlSelection & { __args: {inbound: UpdateUserInput} })
    deleteUser?: (DeleteUserGenqlSelection & { __args: {inbound: DeleteUserInput} })
    /** Mutation to create a user. */
    batchUserCreation?: (BatchUserCreationGenqlSelection & { __args: {stageIds?: ((Scalars['Int'] | null)[] | null), users: (BatchUserInput | null)[]} })
    /** Mutation to customise foyer. */
    sendEmail?: (SendEmailGenqlSelection & { __args: {
    ...
    changePassword?: (ChangePasswordGenqlSelection & { __args: {inbound: ChangePasswordInput} })
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface BatchUserInput {username: Scalars['String'],email: Scalars['String'],password: Scalars['String']}
...
/** Global Id of the user. */
id: Scalars['ID'],oldPassword: Scalars['String'],newPassword: Scalars['String']}
    ...
    const Node_possibleTypes: string[] = ['AssetType','Tag','User','Asset','AssetUsage','Stage','AdminPlayer','Notification','Voice']
    ...
    export const isAssetTypeConnection = (obj?: { __typename?: any } | null): obj is AssetTypeConnection => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAssetTypeConnection"')
    ...
    export const isAssetTypeEdge = (obj?: { __typename?: any } | null): obj is AssetTypeEdge => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAssetTypeEdge"')
    ...
    export const isAssetType = (obj?: { __typename?: any } | null): obj is AssetType => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAssetType"')
    ...
    export const isTagEdge = (obj?: { __typename?: any } | null): obj is TagEdge => {
    ...
    export const isAssignedStage = (obj?: { __typename?: any } | null): obj is AssignedStage => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAssignedStage"')
    ...
    export const isAssetUsage = (obj?: { __typename?: any } | null): obj is AssetUsage => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAssetUsage"')
    ...
    export const isStageConnection = (obj?: { __typename?: any } | null): obj is StageConnection => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isStageConnection"')
    ...
    export const isStageEdge = (obj?: { __typename?: any } | null): obj is StageEdge => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isStageEdge"')
    ...
    export const isStageAttributes = (obj?: { __typename?: any } | null): obj is StageAttributes => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isStageAttributes"')
    ...
    export const isAdminPlayerConnection = (obj?: { __typename?: any } | null): obj is AdminPlayerConnection => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAdminPlayerConnection"')
    ...
    export const isAdminPlayerEdge = (obj?: { __typename?: any } | null): obj is AdminPlayerEdge => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAdminPlayerEdge"')
    ...
    export const isAdminPlayer = (obj?: { __typename?: any } | null): obj is AdminPlayer => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAdminPlayer"')
    ...
    export const isVoiceOutput = (obj?: { __typename?: any } | null): obj is VoiceOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isVoiceOutput"')
    ...
    export const isCalcSizes = (obj?: { __typename?: any } | null): obj is CalcSizes => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isCalcSizes"')
    ...
    export const isDeleteMedia = (obj?: { __typename?: any } | null): obj is DeleteMedia => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isDeleteMedia"')
    ...
    export const isSaveMedia = (obj?: { __typename?: any } | null): obj is SaveMedia => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSaveMedia"')
    ...
    export const isAuthMutation = (obj?: { __typename?: any } | null): obj is AuthMutation => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAuthMutation"')
    ...
    export const isRefreshMutation = (obj?: { __typename?: any } | null): obj is RefreshMutation => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isRefreshMutation"')
    ...
    export const isConfirmPermission = (obj?: { __typename?: any } | null): obj is ConfirmPermission => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isConfirmPermission"')
    ...
    export const isRequestPermission = (obj?: { __typename?: any } | null): obj is RequestPermission => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isRequestPermission"')
    ...
    export const isQuickAssignMutation = (obj?: { __typename?: any } | null): obj is QuickAssignMutation => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isQuickAssignMutation"')
    ...
    export const isUpdateAttributeStatus = (obj?: { __typename?: any } | null): obj is UpdateAttributeStatus => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpdateAttributeStatus"')
      return UpdateAttributeStatus_possibleTypes.includes(obj.__typename)
    }
    


    const UpdateAttributeVisibility_possibleTypes: string[] = ['UpdateAttributeVisibility']
    export const isUpdateAttributeVisibility = (obj?: { __typename?: any } | null): obj is UpdateAttributeVisibility => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpdateAttributeVisibility"')
    ...
    export const isUpdateUser = (obj?: { __typename?: any } | null): obj is UpdateUser => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpdateUser"')
    ...
    export const isDeleteUser = (obj?: { __typename?: any } | null): obj is DeleteUser => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isDeleteUser"')
    ...
    export const isBatchUserCreation = (obj?: { __typename?: any } | null): obj is BatchUserCreation => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBatchUserCreation"')
    ...
    export const isSendEmail = (obj?: { __typename?: any } | null): obj is SendEmail => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSendEmail"')
    ...
    export const isChangePassword = (obj?: { __typename?: any } | null): obj is ChangePassword => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isChangePassword"')
