<template>
    <p>
        ...
        <a href="https://obsproject.com/download" target="_blank">{{ $t("here") }}</a>.
    </p>
    <div>
        <div class="mt-4">
            <b>Step 1:&nbsp;</b>Open OBS Studio and click
            <code class="text-red-600 bg-gray-200 p-1 text-sm">{{ $t("settings") }}</code>
        </div>
        <div>
    ...
    <div>
        <div class="mt-4">
            ...
            <code class="text-red-600 bg-gray-200 p-1 text-sm">{{ $t("stop_streaming") }}</code> and LIVE counter started to work.
            If you
